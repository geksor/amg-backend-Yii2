...
//        $ChatServer->port = 8080; //This port must be busy by WebServer and we handle an error
//
...
//        $ChatServer->start();
        ...
        $testServer->port = 443; //This port must be busy by WebServer and we handle an error
